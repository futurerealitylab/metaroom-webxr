...
export class MIDIInterface {
    ...
    static init(args) {
        ...
        MIDIInterface.onInit = args.onInit;

        MIDIInterface.onStateChange = args.onStateChange;

        return navigator.requestMIDIAccess().then((midiAccess) => {
            MIDIInterface.access  = midiAccess;

            if (MIDIInterface.onInit) {
                MIDIInterface.onInit();
            }
            ...
            MIDIInterface.access.onstatechange = (e) => {
                ...
                if (MIDIInterface.onStateChange) {
                    MIDIInterface.onStateChange(e);
                }
            }
