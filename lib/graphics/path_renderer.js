...
export function pushVertexColor(self, x, y, z, r, g, b, a) {
    ...
    //console.log("push_v: [%f,%f][%f,%f,%f,%f], vcount=[%f]", x, y, r,g,b,a, buf.count/7);
...
export function pushArrayLineVertexInterleavedColor(self, arr) {

    if (self.pathStarted) {
        self.pathStarted = false;
        pushVertexColor(self, 
            arr[0], arr[1], arr[2], 
...
export function endLine(self) {
    ...
    if (buf[posA    ] == buf[posB    ] &&
        ...
        self.gpuState.lineVertexData.popk(LAYOUT_COMPONENT_COUNT_DEFAULT);
    }
...
export class PathRenderer_GL {
    ...
    pushArrayLineVertexInterleavedColor(arr) {
        pushArrayLineVertexInterleavedColor(this, arr);
    }
    endLine() {
        endLine(this);
    }
