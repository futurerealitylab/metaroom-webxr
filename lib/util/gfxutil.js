...
window.GFX = (function() {
    ...
    function compileValidateStrings(vertSrc, fragSrc, errRecord) {
        ...
        const vshader = GFX.addShaderModule(program, gl.VERTEX_SHADER, vertSrc, errRecord);
        const fshader = GFX.addShaderModule(program, gl.FRAGMENT_SHADER, fragSrc, errRecord);
    ...
    function shaderCompileValidateStringsEX(vertSrc, fragSrc) {
        const program = gl.createProgram();
        const vshader = GFX.addShaderModule(program, gl.VERTEX_SHADER, vertSrc);
        const fshader = GFX.addShaderModule(program, gl.FRAGMENT_SHADER, fragSrc);
