...
export class SpatialAudioContext {
    ...
    static binaryLoaderProc = async function(url, opts) {};
    static binaryLoaderGetDataProc = async function() { return null; }

    static setBinaryLoaderProc(loaderProc) {
        SpatialAudioContext.binaryLoaderProc = loaderProc;         
    }

    static setBinaryLoaderGetDataProc(getDataProc) {
        SpatialAudioContext.binaryLoaderGetDataProc = getDataProc;
    }
...
// 
    ...
    async loadFile(url) {
        ...
        const result = await SpatialAudioContext.binaryLoaderProc(url, {
        ...
        const audioBuffer = await this.context.decodeAudioData(
            SpatialAudioContext.binaryLoaderGetDataProc(
                result
            )
        );
