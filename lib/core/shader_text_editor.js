...
const ShaderTextEditor = (function() {
    ...
    _out.loadAndRegisterShaderLibrariesForLiveEditing = loadLibs;
    ...
    function registerShaderForLiveEditing(_gl, key, args, callbacks, options) {
        ...
        if ((options && (options.doCompilationAfterFirstSetup !== false)) || !options) {
            ...
            if (record.hasError) {
                ...
                const shaderProgram = GFX.createShaderProgramFromStrings(defaultErrorVertex, defaultErrorFragment);
                if (record.onAfterCompilation) {
